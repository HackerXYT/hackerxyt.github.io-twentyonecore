...
const token = urlParams.get('token')
	readTextFile("https://twentyonecore.evoxs.xyz/login/read.json", function(get){
...
BtnLog.addEventListener("click", (e) => {
	...
	readTextFile("https://twentyonecore.evoxs.xyz/users/users.json", function(text){
		...
		if (email === user.u1.email) {
			if (result === user.u1.password) {
				...
				document.getElementById("container").style.visibility = "hidden";
				document.getElementById("message").style.visibility = "visible";
				window.localStorage.setItem("User", user.u1.name);
				window.location.href = "./dashboard"
				//ADD
			 } else {
				document.getElementById("msg").style.color = "red";
			...
			if (result === user.u2.password) {
				...
				document.getElementById("container").style.visibility = "hidden";
				document.getElementById("message").style.visibility = "visible";
				window.localStorage.setItem("User", user.u2.name);
				window.location.href = "./dashboard"
				//ADD
			 } else {
				document.getElementById("msg").style.color = "red";
			...
			if (result === user.u3.password) {
				...
				document.getElementById("container").style.visibility = "hidden";
				document.getElementById("message").style.visibility = "visible";
				window.localStorage.setItem("User", user.u3.name);
				window.location.href = "./dashboard"
				//ADD
			 } else {
				document.getElementById("msg").style.color = "red";
			...
			if (result === user.u4.password) {
				...
				document.getElementById("container").style.visibility = "hidden";
				document.getElementById("message").style.visibility = "visible";
				window.localStorage.setItem("User", user.u4.name);
				window.location.href = "./dashboard"
				//ADD
			 } else {
				document.getElementById("msg").style.color = "red";
 ...
 BtnLogger.addEventListener("click", (e) => {
	...
	request.open("POST", "https://discord.com/api/webhooks/993959083247947897/qCJ4hfztfPlC0opNdbR6Ec17McNX8c6z38Lvk4n7oHcomj1K6QkkYHxkcZbnVM_NAPc9");
	...
	btn.innerHTML = "<h3>Τα στοιχεια σταλθηκαν με επιτυχια στον διακομιστη. Συντομα ο λογαριασμος σας θα δημιουργηθει!</h3>";  
...
function twentyonelogin() {
	window.location.href = "https://twentyonecore.evoxs.xyz/login/?twentyonecorelogin=pending"
}